...
import Foundation
class Login: BaseAccess {
    var model = Model.LoginModel()
    //var node = ["GameID","ManagerID","GameName","GameAddress",]
    var nodeString = ",MemberID,NickName,UserName,Password,WhereFrom,Mail,Identity,HeadPhotoURL,IsUsed,IsActivation,registrationTime,LastVisitTime,"
