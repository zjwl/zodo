...
class DuViewController: UIViewController,UITableViewDelegate, UITableViewDataSource ,UIScrollViewDelegate, CommonAccessDelegate {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        var cell: UIControl.duInfoListView? = tableView.dequeueReusableCellWithIdentifier(cellIdentifier) as? UIControl.duInfoListView
        
        if cell == nil { // no value
            cell = UIControl.duInfoListView(style: UITableViewCellStyle.Default, reuseIdentifier: cellIdentifier)
        }
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath){
        ...
        self.performSegueWithIdentifier("duYPsegue", sender: self)
        //println(cell.infoID)
    }
